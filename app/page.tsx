  ...
  if (session) {
    ...
    return (
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <div
          className={`md:hidden fixed top-16 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm overflow-hidden transition-[max-height] duration-300 ease-in-out ${
            menuOpen ? "max-h-[600px] shadow-lg border-b border-gray-200" : "max-h-0"
          }`}
        >
